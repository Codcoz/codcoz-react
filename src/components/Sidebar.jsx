...
const menuItems = [
  ...
  { id: "pedidos", icon: FileText, label: "Tarefas" },
  { id: "produtos", icon: Package, label: "Alimentos" },
  { id: "gastronomia", icon: UtensilsCrossed, label: "Gastronomia" },
  { id: "xml", icon: FileText, label: "Entrada de XML" },
  { id: "relatorios", icon: MessageSquare, label: "Relatórios" },
];
...
export default function Sidebar({ currentPage, onNavigate, onWidthChange }) {
  ...
  return (
    ...
    >
      <div
        className="absolute top-6 w-[72px] h-[72px] shrink-0 pointer-events-none z-10"
        style={{
          left: "8px",
          maxWidth: "72px",
          minWidth: "72px",
